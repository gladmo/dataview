...
export default withEnglishFallback({
  ...
  dataView: {
    ...
    untitledQuery: "未命名查询",
    running: "正在查询…",
    emptyRunHint: "填写变量并点击查询以查看结果。",
    emptyListHint: "还没有数据视图。可从查询页添加，或新建一个视图。",
    addToDataView: "添加到数据视图",
    addToExisting: "添加到已有视图",
    createNew: "新建视图",
    queryTitle: "查询标题",
    variables: "变量",
    queries: "查询",
    defaultDisplayMode: "默认显示",
    save: "保存",
    cancel: "取消",
    delete: "删除",
    edit: "编辑",
    ...
    variableKind: "类型",
    variableDefault: "默认值",
    confirmDelete: "确定删除该数据视图？",
    createdFromQuery: "已添加到数据视图",
    query: "查询",
    mutation: "更新",
    updates: "数据更新",
    executeUpdate: "执行更新",
    confirmUpdate: '确定执行更新"{name}"？该操作会修改数据。',
    affectedRows: "影响 {count} 行",
    dynamicDefaultHint: "动态默认值：today、yesterday、tomorrow、now（用双花括号包裹）",
    inheritDisplayMode: "跟随视图默认",
    preview: "预览",
    previewView: "预览整个看板",
    refresh: "刷新",
    search: "搜索数据视图",
    noSearchResults: "没有匹配的数据视图",
    back: "返回列表",
    confirmDeleteMessage: "确定删除「{name}」吗？此操作无法撤销。",
    multiStatementSplitHint: "当前查询页有 {count} 个查询块，将分别添加为独立查询。",
    addQuery: "添加查询",
    emptyQueriesHint: "该视图还没有查询，点击“添加查询”开始。",
    selectConnectionFirst: "请选择连接",
    collapseQuery: "收起",
    expandQuery: "展开",
    editLayout: "编辑布局",
    doneEditing: "完成",
